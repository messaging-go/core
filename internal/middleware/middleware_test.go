...
func (r customMw) Process(ctx context.Context, item int, next func(ctx context.Context, item int) int) int {
	return next(context.WithValue(ctx, "key", "some-value"), item+5) //nolint:staticcheck // for testing.
}
...
func TestNew(t *testing.T) {
	...
	t.Run("with middleware", func(t *testing.T) {
		...
		finalMiddleware := middleware.FinalMiddleware[int, int](func(ctx context.Context, item int) int {
			return item * item
		})
		pipeline.AddMiddleware(finalMiddleware)
